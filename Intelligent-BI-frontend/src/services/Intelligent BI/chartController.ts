...
export async function genChartByAiAsyncMqUsingPost1(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.genChartByAiAsyncMqUsingPOST1Params,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
...
/** genChartByAiAsyncMq POST /api/chart/gen/async/rebuild */
...
/** queryChartData GET /api/chart/queryChartData */
export async function queryChartDataUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.queryChartDataUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseChartVO_>('/api/chart/queryChartData', {
    method: 'GET',
    params: {
      ...params,
    },
...
/** test POST /api/chart/test */
export async function testUsingPost(body: API.ChartQueryRequest, options?: { [key: string]: any }) {
  return request<API.BaseResponseLong_>('/api/chart/test', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
